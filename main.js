class Mygame {
    ...
    detectCollision(fireballInstance) {
      if (
        this.player.positionX < fireballInstance.positionX + fireballInstance.width &&
        this.player.positionX + this.player.width > fireballInstance.positionX &&
        this.player.positionY < fireballInstance.positionX + fireballInstance.height &&
        this.player.height + this.player.positionY > fireballInstance.positionY
      ) {
        // add something to count bonuses
      }
    }
...
detectCollision(snow) {
  ...
  class Fireball {
    ...
    createDomElmFireball() {
      ...
      this.fireballElm.style.left = this.positionY + "vw";
